...
extern void SDMLIB_API cm_ini P_((p_cm_t p_cm));

/* Initializes the argument CRC model instance. 	 */
/* All parameter fields must be set before calling this. */

extern void SDMLIB_API cm_nxt P_((p_cm_t p_cm,int ch));


/* Processes a single message byte [0,255]. */

extern void SDMLIB_API cm_blk P_((p_cm_t p_cm,p_ubyte_ blk_adr,ulong blk_len));

/* Processes a block of message bytes. */

extern ulong SDMLIB_API cm_crc P_((p_cm_t p_cm));
...
extern ulong SDMLIB_API cm_tab P_((p_cm_t p_cm,int index));
