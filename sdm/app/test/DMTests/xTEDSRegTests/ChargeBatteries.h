#ifndef _CHARGEBATTERIES_XTEDS_H
#define _CHARGEBATTERIES_XTEDS_H

#define _STRING_CHARGEBATTERIES_XTEDS \
"<?xml version=\"1.0\" encoding=\"UTF-8\"?>" \
"<xTEDS xmlns=\"http://www.interfacecontrol.com/SPA/xTEDS\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"" \
"xsi:schemaLocation=\"http://www.interfacecontrol.com/SPA/xTEDS xTEDS02.xsd\" name=\"ActivityAgentXTEDS\" description=\"ActivityAgent xTEDS\" version=\"2.3\">" \
"" \
"<Application name=\"ChargeBatteries\" kind=\"AutonomyFlightSoftware\" description=\"Autonomous Tasking Executive (ATE), ActivityAgent\"/>" \
"" \
...
"" \
"<Variable name=\"ActivityName\" kind=\"tbd\" format=\"UINT08\" length=\"33\"/><!-- 33-byte, null terminated string -->" \
